...
<img src="../image/postgres整体架构.png" align="middle">
## 1. 查询树中的节点类型
### 1.1 Node
...
```
[![查看用户密码信息](../image/sample4.node.jpg "password")](https://github.com/nullemp/postgres_notes/blob/master/image/Snipaste_2023-11-03_18-47-59.png?raw=true)

```
SELECT sno FROM (SELECT sno FROM STUDENT WHERE sno > ANY (SELECT sno FROM SCORE)) sc LEFT JOIN COURSE ON TRUE ; 

```
[![查看用户密码信息](../image/sample5.node.jpg
 "password")](https://github.com/nullemp/postgres_notes/blob/master/image/Snipaste_2023-11-03_18-47-59.png?raw=true)
...
typedef struct FromExpr
{
 ...
 ```
[![查看用户密码信息](../image/sample6.node.jpg
 "password")](https://github.com/nullemp/postgres_notes/blob/master/image/Snipaste_2023-11-03_18-47-59.png?raw=true)
...
[![查看用户密码信息](../image/Snipaste_2023-11-16_13-38-52.png "password")](https://github.com/nullemp/postgres_notes/blob/master/image/Snipaste_2023-11-03_18-47-59.png?raw=true)

[![查看用户密码信息](../image/Snipaste_2023-11-16_14-19-33.png "password")](https://github.com/nullemp/postgres_notes/blob/master/image/Snipaste_2023-11-03_18-47-59.png?raw=true)
...
[![查看用户密码信息](../image/Snipaste_2023-11-16_14-24-49.png "password")](https://github.com/nullemp/postgres_notes/blob/master/image/Snipaste_2023-11-03_18-47-59.png?raw=true)
...
[![查看用户密码信息](../image/Snipaste_2023-11-16_14-40-47.png "password")](https://github.com/nullemp/postgres_notes/blob/master/image/Snipaste_2023-11-03_18-47-59.png?raw=true)
...
[![查看用户密码信息](../image/sample7.node.jpg "password")](https://github.com/nullemp/postgres_notes/blob/master/image/Snipaste_2023-11-03_18-47-59.png?raw=true)